...
describe("CCM", () => {
    ...
    describe("Test in-between token tax transfers (WETH taxes)", async() => {
        ...
        it("Contract sells stack for 10% for each sell, reset on buy. Check if bob gets all the fees", async() => {
            ...
            const bobWethBefore = await MyWBNBContract.balanceOf(tcStackingSellContract.address);
            ...
            const bobWethAfter = await MyWBNBContract.balanceOf(tcStackingSellContract.address);
